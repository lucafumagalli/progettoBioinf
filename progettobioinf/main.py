...
if __name__ == "__main__":
    ...
    models.extend([modelperc, modeltree, modelmlp, modelffnn, modelrf])
    kwargs.extend([kwargsperc, kwargstree, kwargsmlp, kwargsffnn, kwargsrf])
    ...
    barplot(df_promoters, cell_line, 'enhancers')